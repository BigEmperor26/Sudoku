...
export default function SwipeableDrawerWrapper({ state, onOpenClose, children }: Readonly<SwipeableDrawerWrapperProps>) {
  return (
    <SwipeableDrawer
      open={state}
      anchor="bottom"
    ...
    >
      ...
      >
        ...
        <Box sx={{ maxHeight: '65vh', overflowY: 'auto', overflowX: 'hidden', width: '100%' }}>{children}</Box>
      </Stack>
    </SwipeableDrawer>
  );
}
